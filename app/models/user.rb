  ...
  #TODO allow multiple users to have the artist relationship
...
# Sets the password reset attributes.
  ...
  def assign_artist(artist)
    artist_relationships.create(artist_id: artist.id)
  end

  # Returns assigned artists
  #TODO make this method more like 'the rails way'
  def assigned_artists
    artists = Array.new
    self.artist_relationships.each do |relationship|
